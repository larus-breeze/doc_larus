...
The Larus sensor can log its inputs to a micro-SD storage card. The micro-SD is written approximately two times per second. In case of an accident the logged data can be used to investigate the flight history in general and especially accidents. 
