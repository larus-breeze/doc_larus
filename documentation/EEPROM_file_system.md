...
16 bit: **Direct data** if applicable (data set size 1)
       or 16bit **CRC checksum** of the complete data set information including ID and size.
...
For the Larus project the following **data types** are used:  
 ...
 14. GNSS antennas down parameter (Position relative to the primary antenna)
 15. GNSS antennas right parameter
 16. Magnetic sensor calibration parameters: 16 * float32_t (=sensor transfer matrix)
 17. External magnetic sensor calibration parameters: 16 * float32_t (=sensor transfer matrix)
